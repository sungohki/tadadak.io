class f {
  constructor(t, a) {
    this.advices = t, this.KadviceStorageService = a;
  }
  getAll(t) {
    return this.filter(t);
  }
  getOne(t) {
    return this.shuffle(this.getAll(t));
  }
  getOneByDaily(t) {
    const a = this.getAll(t), r = this.KadviceStorageService.getCurrentAdviceIndex(
      a.length
    );
    return a[r];
  }
  ...
  filter(t) {
    return t ? this.advices.filter(({ tag: a }) => a === t) : this.advices;
  }
  /**
   * @deprecated getAll
   */
   ...
   */
  daily(t) {
    return this.getOneByDaily(t);
  }
}
class m {
  constructor(t = "count", a = "midNight") {
    this.countKey = t, this.midNightKey = a;
  }
  getCurrentAdviceIndex(t) {
    const [a, r] = this.initializeCountAndMidnightKeys();
    if ((/* @__PURE__ */ new Date()).getTime() >= r) {
      this.setStorage(this.midNightKey, this.getCurrentMidNightTime());
      const h = a + 1;
      return t >= h ? (this.setStorage(this.countKey, h), h) : (this.setStorage(this.countKey, 0), 0);
    }
    return 0;
  }
  initializeCountAndMidnightKeys() {
    const t = this.countKey, a = this.midNightKey;
    let r = this.getStorage(t), o = this.getStorage(a);
    return r === null && (r = 0, this.setStorage(t, 0)), o === null && (o = this.getCurrentMidNightTime(), this.setStorage(a, this.getCurrentMidNightTime())), [r, o];
  }
  getCurrentMidNightTime() {
    return (/* @__PURE__ */ new Date()).setHours(24, 0, 0, 0);
  }
  getStorage(t) {
    const a = localStorage.getItem(t);
    if (a)
      try {
        return Number(JSON.parse(a));
      } catch {
        return null;
      }
    return null;
...
var u = /* @__PURE__ */ ((e) => (e[e.LIFE = 1] = "LIFE", e[e.MOTIVATION = 2] = "MOTIVATION", e[e.ETC = 3] = "ETC", e))(u || {});
function n(e) {
  return e === u.LIFE ? g : e === u.MOTIVATION ? i : e === u.ETC ? l : [
    ...g,
    ...i,
    ...l
  ];
...
export {
  f as KadviceService,
  m as KadviceStorageService,
  u as KadviceTagEnum,
  n as getAdviceFixtures,
  d as kadvice
};
